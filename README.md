...
## Tabla Oficial de Niveles (Bolivia 2026)

| Nivel | Inversión (BOB) | Tareas/Día | Pago Tarea (BOB) | Ingreso Diario (BOB) | Ingreso Mensual (BOB) | Ingreso Anual (BOB) |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Interno** | 0.00 | 3 | 1.00 | 3.00 | — | — |
| **GLOBAL 1** | 230.00 | 4 | 1.80 | 7.20 | 216.00 | 2,628.00 |
| **GLOBAL 2** | 780.00 | 8 | 3.22 | 25.76 | 772.80 | 9,402.40 |
| **GLOBAL 3** | 2,900.00 | 15 | 6.76 | 101.40 | 3,042.00 | 37,011.00 |
| **GLOBAL 4** | 9,200.00 | 30 | 11.33 | 339.90 | 10,197.00 | 124,063.50 |
| **GLOBAL 5** | 28,200.00 | 60 | 17.43 | 1,045.80 | 31,374.00 | 381,717.00 |
| **GLOBAL 6** | 58,000.00 | 100 | 22.35 | 2,235.00 | 67,050.00 | 815,775.00 |
| **GLOBAL 7** | 124,000.00 | 160 | 31.01 | 4,961.60 | 148,848.00 | 1,810,984.00 |
| **GLOBAL 8** | 299,400.00 | 250 | 47.91 | 11,977.50 | 359,325.00 | 4,371,787.50 |
| **GLOBAL 9** | 541,600.00 | 400 | 58.87 | 23,548.00 | 706,440.00 | 8,595,020.00 |
...
- **Login 401**: El sistema normaliza automáticamente el teléfono. Acepta `70000001`, `5170000001` y `+5170000001`. Si persiste, verifica que el `password_hash` en la DB sea compatible con `bcryptjs`.
