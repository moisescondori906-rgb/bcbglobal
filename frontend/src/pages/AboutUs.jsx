...
export default function AboutUs() {
  ...
  const content = {
    empresa: {
      title: "BCB Global Institucional Bolivia",
      subtitle: "Líderes en Gestión de Activos Digitales",
      description: "Fundada en Colorado, EE.UU., BCB Global es una plataforma de vanguardia que expande sus operaciones a Bolivia para democratizar el acceso a mercados de alta rentabilidad mediante la tecnología blockchain y el marketing de tareas digitales.",
      items: [
        ...
        { icon: Target, text: "Misión: Crear libertad financiera sostenible en Bolivia." }
      ]
    },
    inversion: {
    ...
    retiros: {
      ...
      items: [
        { icon: ShieldCheck, text: "Retiros habilitados de Lunes a Viernes." },
  ...
  return (
    <Layout>
      ...
      <main className="p-5 space-y-6 pb-20 animate-fade">
                  ...
                  <div className="bg-slate-50 rounded-3xl p-6 border border-slate-100 shadow-inner space-y-4">
                    ...
                    <div className="grid grid-cols-7 gap-2">
                      {['L', 'M', 'M', 'J', 'V', 'S', 'D'].map((day, i) => {
                        const isAllowed = i >= 0 && i <= 4; // L a V (0 a 4 en este array de 0-6)
                        return (
        ...
        {/* Footer Info */}
        <div className="text-center space-y-2 opacity-40 pt-4">
          <p className="text-[8px] font-black text-slate-400 uppercase tracking-[0.4em]">© 2026 BCB Global Asset Management</p>
          <p className="text-[7px] font-bold text-slate-400 uppercase tracking-widest">Colorado, USA • Global Operations</p>
        </div>
