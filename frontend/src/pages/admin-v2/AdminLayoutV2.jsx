    ...
    <div className="min-h-screen bg-[#0f111a] text-slate-200 flex overflow-hidden">
      ...
      >
                  ...
                  return (
                    <Link
                      ...
                      className={`
                        ...
                        ${isActive 
                          ? 'bg-sav-primary/10 text-sav-primary border border-sav-primary/20 shadow-lg shadow-sav-primary/5' 
                          : 'hover:bg-white/[0.03] text-slate-400 hover:text-slate-200 border border-transparent'
                        }
                      `}
                    >
                      <item.icon size={18} className={`transition-colors ${isActive ? 'text-sav-dark' : 'text-slate-500 group-hover:text-slate-300'}`} />
        ...
        <div className="p-4 border-t border-white/5 bg-[#1a1e2e]/50">
          ...
          <button 
            onClick={logout}
            className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-rose-500/10 text-rose-700 hover:bg-rose-500 hover:text-white transition-all duration-300 text-[10px] font-black uppercase tracking-widest border border-rose-500/20"
          >
