...
conn.on('ready', () => {
  ...
  const searchScript = `
    ...
    # Primero creamos un script .js con CommonJS para evitar conflictos con las comillas invertidas
    cat > buscar-usuario-final.cjs << 'EOF'
