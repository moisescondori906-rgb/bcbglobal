...
export const levels = [
  { id: 'l1', codigo: 'internar', nombre: 'Internar', deposito: 0, num_tareas_diarias: 3, ganancia_tarea: 1.00, orden: 0, activo: true },
  { id: 'l2', codigo: 'global1', nombre: 'Global 1', deposito: 230, num_tareas_diarias: 4, ganancia_tarea: 1.80, orden: 1, activo: true },
  { id: 'l3', codigo: 'global2', nombre: 'Global 2', deposito: 780, num_tareas_diarias: 8, ganancia_tarea: 3.22, orden: 2, activo: true },
  { id: 'l4', codigo: 'global3', nombre: 'Global 3', deposito: 2900, num_tareas_diarias: 15, ganancia_tarea: 6.76, orden: 3, activo: true },
  { id: 'l5', codigo: 'global4', nombre: 'Global 4', deposito: 9200, num_tareas_diarias: 30, ganancia_tarea: 11.33, orden: 4, activo: true },
  { id: 'l6', codigo: 'global5', nombre: 'Global 5', deposito: 28200, num_tareas_diarias: 60, ganancia_tarea: 17.43, orden: 5, activo: true },
  { id: 'l7', codigo: 'global6', nombre: 'Global 6', deposito: 58000, num_tareas_diarias: 100, ganancia_tarea: 22.35, orden: 6, activo: true },
  { id: 'l8', codigo: 'global7', nombre: 'Global 7', deposito: 124000, num_tareas_diarias: 160, ganancia_tarea: 31.01, orden: 7, activo: true },
  { id: 'l9', codigo: 'global8', nombre: 'Global 8', deposito: 299400, num_tareas_diarias: 250, ganancia_tarea: 47.91, orden: 8, activo: true },
  { id: 'l10', codigo: 'global9', nombre: 'Global 9', deposito: 541600, num_tareas_diarias: 400, ganancia_tarea: 58.87, orden: 9, activo: true },
];
