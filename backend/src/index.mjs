...
const API_VERSION = '11.2.4';

// Endpoint de Healthcheck Profesional v11.2.4 (Resiliente y Real)
...
async function startServer() {
  try {
    ...
    const server = app.listen(PORT, '0.0.0.0', () => {
      console.log(`[SERVER] BCB Global Backend v11.2.4 estable en puerto ${PORT}`);
