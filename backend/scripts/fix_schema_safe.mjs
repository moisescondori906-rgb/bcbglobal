...
async function runMigrations() {
  ...
  try {
    ...
    if (premios[0].total === 0) {
      ...
      const basePremios = [
        { nombre: '1 Bs', tipo: 'comision', valor: 1.00, prob: 40, color: '#4f46e5' },
        { nombre: '3 Bs', tipo: 'comision', valor: 3.00, prob: 25, color: '#7c3aed' },
        { nombre: '5 Bs', tipo: 'comision', valor: 5.00, prob: 15, color: '#2563eb' },
        { nombre: '10 Bs', tipo: 'comision', valor: 10.00, prob: 5, color: '#0891b2' },
